...
namespace ShopGoods.Controls
{
    public partial class CategoryList : System.Web.UI.UserControl
    {
        ...
        {
            return new Repository().Goods.Select(p => p.GoodsCompany).Distinct().OrderBy(x => x);
        }
        ...
        protected string CreateAdminLinkHtml()
        {
            string path = RouteTable.Routes.GetVirtualPath(null, null).VirtualPath;
            return string.Format("<a href='{0}'>Админка</a>", path + "admin/goods");
        }
